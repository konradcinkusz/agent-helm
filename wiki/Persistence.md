...
`NativeSessionId` — the agent's own session id — is what makes [resume](History-and-Resume.md#resuming-a-session) possible; rows written before it existed have none.
