...
> **Note:** This page lists what the suite covers rather than how many tests it has — a count in prose goes stale with the next test and nothing would notice.
...
Before a release, walk through the manual smoke test in [CI/CD & releases](CI-and-Releases.md#release-checklist): an echo session from a cold start, a permission request, YOLO, history and resume, and one real agent.
