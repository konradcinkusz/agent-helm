---
description: Continue a conversation with a different agent — what the handoff creates, what the summary contains, and why it is never sent automatically.
---
...
![The handoff panel](../assets/screenshots/handoff-panel.png){ loading=lazy }
...
> [!IMPORTANT]
> The summary is **never sent automatically**. You see exactly what the next agent will read, and nothing leaves AgentHelm until you press Send.
